...
run_initial_setup() {
    ...
    echo "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo "${YELLOW}📊 容量表示に関する重要な注意${NC}"
    echo "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
    echo "${ORANGE}⚠️  Finderの「ストレージ」画面で容量が増えて見える場合があります${NC}"
    echo ""
    echo "${WHITE}理由: APFSの仕様により、複数ボリュームの論理サイズが重複カウントされます${NC}"
    echo "${GRAY}  • 実際の物理使用量: Macintosh HDの「使用済み」(上部の数値)${NC}"
    echo "${GRAY}  • 各ボリュームの合計: 個別カテゴリの合計 (重複を含む論理値)${NC}"
    echo ""
    echo "${GREEN}✅ 外部ボリュームに移行することで、内蔵ストレージは確実に節約されます${NC}"
    echo "${WHITE}   実際の効果は Macintosh HDの「使用済み」の数値で確認できます${NC}"
    echo ""
    echo "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
    echo ""
